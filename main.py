...
STATIC_RESPONSES = {
    # 공통 키워드 (모든 미션 적용)
    "common": {
        "hello": ["네, 안녕하세요.", "반갑습니다.", "누구시죠?", "업무 중입니다만.","하이","안녕","누구?"],
        "who_are_you": ["저는 이 부서 담당자입니다.", "제 신분을 밝혀야 합니까?"],
        "game_over": ["더 이상 할 말이 없군요. (접속 차단)"],
    },
    # 튜토리얼: 신입 사원 이민수 (AI 사용 안 함 권장)
    "mission_Tutorial": {
        "사원번호": ["제 사원번호는 2024001입니다! 절대 안 까먹어요.", "2024001입니다. 선배님은요?"],
        "비밀번호": ["초기 비밀번호 규칙이 '사원번호 앞 1자리 + 입사년도 + 회사명' 이니까... 아마 12024CorpX 일걸요?", "저도 처음에 헷갈렸습다!"],
        "default": ["죄송해요, 제가 신입이라 잘 못 알아들었어요. '비밀번호'나 '사원번호'에 대해 물어봐 주시겠어요?"]
    },
    # 미션 1: 김철수 부장
    "mission_1": {
        "인사": ["어, 자네 인사가 늦군.", "김철수 부장일세. 무슨 일인가?"],
        "비밀번호": ["비밀번호? 그걸 왜 묻나? 보안팀에 물어봐!", "내 비밀번호는 내 머릿속에 있네. 묻지 말게."],
        "blue_sky": ["파란 하늘... 그래, 우리 아내가 참 좋아했지.", "어? 그 단어를 자네가 어떻게 아나?"]
    },
    # 미션 2: 박지현 대리
    "mission_2": {
        "강아지": ["우리 렉스요? 진짜 귀엽죠!! 인스타 보셨어요?", "강아지는 사랑입니다ㅠㅠ"],
        "인스타": ["제 인스타 아이디는 @dev_jihyun 이에요! 팔로우 해주세요~"],
        "비번": ["비밀번호요? 절대 안 알려주죠~ 힌트는 인스타에 있는데!"]
    }
}
